public class TreeTest {
    ...
    public static void main(String[] args) {
        ...
        Testcase test7 = new Testcase("inf=8,*,9,+,10,/,43", "pos=8,9,*,10,43,/,+");
        ...
        Testcase test8 = new Testcase("inf=42,*,9813,+,1009,/,912", "pos=42,9813,*,1009,912,/,+");
        ...
        Testcase test9 = new Testcase("inf=5,+,3,*,6,/,12", "pos=5,3,6,12,/,*,+");
        test9.setIsMathExpression(true);
        test9.setNotationStrings("5+3*6/12", "53612/*+", "+5*3/612");
        test9.setSolution(5 + (3 * (6 / 12)));
        test9.test();

        Testcase test10 = new Testcase("inf=6,-,3,*,5,+,1,/,2", "pos=6,3,-,5,*,1,+,2,/");
